...
if (user == "") {
	...
	println('Logging in as ' + GlobalVariable.user1Name1Name1Name)

	WebUI.setText(findTestObject('Page_tC Create/input__username'), GlobalVariable.user1Name1Name1Name)

	WebUI.setText(findTestObject('Page_tC Create/input__password'), GlobalVariable.user1Name1Name1Password)
