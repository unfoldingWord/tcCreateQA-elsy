...
//        }
        ...
        if (!fixedRows.contains(0)) {
            ...
            WebUI.setText(findTestObject('Page_tCC translationNotes/input_Search'), 'j1o7')
        ...
        if (!fixedRows.contains(3)) {
            ...
            WebUI.setText(findTestObject('Page_tCC translationNotes/input_Search'), 'y1jl')
        ...
        if (!fixedRows.contains(4)) {
            ...
            WebUI.setText(findTestObject('Page_tCC translationNotes/input_Search'), 'kr99')
		...
		if (!fixedRows.contains(row)) {
            ...
            println(prefix + 'ERROR: Validator reports a ' + basePrioritys[row] + ' error in ' + testFile + ' even though the snippet is highlighted and there are no other error in th check. (Issue 714)')
            CustomKeywords.'unfoldingWord_Keywords.SendMessage.SendFailMessage'(prefix + 'Test failed because the validator reports a ' + basePrioritys[row] + ' error in ' + testFile + ' even though the snippet is highlighted and there are no other error in th check. (Issue 714)')
        } else {
            passCount++
        }
    }
