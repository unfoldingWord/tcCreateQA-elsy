...
WebUI.click(findTestObject('Object Repository/tW Objects/Page_tC Create/svg_en_tw_MuiSvgIcon-root MuiChip-deleteIcon MuiChip-deleteIconColorPrimary'))

System.out.println("Closed the button")
