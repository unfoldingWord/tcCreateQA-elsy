...
//WebUI.scrollToElement(findTestObject('Page_tC Create/Intro-h6_TIT 1intro'), 5)
// Check the UGNT in PSV
//WebUI.click(findTestObject('Page_tC Create/PSV UGNT Header'))
//WebUI.click(findTestObject('Page_tC Create/span_unfoldingWord Literal Text v14'))
...
//WebUI.click(findTestObject('Page_tC Create/span_unfoldingWord Simplified Text v14'))
