...
CustomKeywords.'com.tccreate.keywords.WriteToFile.writeTofilename'('OBS-tN-Save')
...
WebUI.click(findTestObject('Object Repository/OBS-tn/div_the beautiful garden edits box'))

WebUI.sendKeys(findTestObject('Object Repository/OBS-tn/div_the beautiful garden edits box'), '  edits by a test script')
...
WebUI.click(findTestObject('Object Repository/OBS-tn/div_English - unfoldingWorden_obs-tnElsyLambert-tc-create-1'))
WebUI.delay(2)
WebUI.switchToWindowIndex(1)
if (WebUI.getText(findTestObject('Object Repository/OBS-tn/h1_the beautiful garden on DCS')).contains('edits by a test script'))
{
