...
for (def fileNum : (start..end)) {
    ...
    if (fileNum == 0) {
		...
		/*WebUI.click(findTestObject('Page_tCC translationNotes/text_OccurrenceNote_SearchId'))
        noteText = WebUI.getText(findTestObject('Page_tCC translationNotes/text_OccurrenceNote_SearchId'))
